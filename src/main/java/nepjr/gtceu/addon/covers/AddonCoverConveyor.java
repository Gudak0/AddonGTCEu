...
public class AddonCoverConveyor extends CoverBehavior implements CoverWithUI, ITickable, IControllable {
    ...
    public AddonCoverConveyor(ICoverable coverable, EnumFacing attachedSide, int tier, int itemsPerSecond) {
